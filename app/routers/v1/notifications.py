...
@router.get('', status_code=status.HTTP_200_OK, response_model=list[NotificationPrivate])
...
@router.post('', status_code=status.HTTP_201_CREATED, response_model=NotificationPrivate)
...
@router.patch('/{notification_id}', status_code=status.HTTP_200_OK, response_model=NotificationPrivate)
